...
public class Reset implements Screen {
    ...
    private void drawResetText() {
        ...
        game.font.draw(game.batch, "all game data will be cleared", RhythmGame.V_WIDTH / 2 - TextUtil.getTextWidth(game.font, "All game data will be cleared") / 2, 380);
        game.font.draw(game.batch, "do you wish to proceed?", RhythmGame.V_WIDTH / 2 - TextUtil.getTextWidth(game.font, "do you wish to proceed?") / 2, 330);
    }
    ...
    private void drawSelectionText() {
        ...
        if (selection == 0) {
            ...
            game.font.draw(game.batch, "NO", RhythmGame.V_WIDTH / 2 - TextUtil.getTextWidth(game.font,"NO") / 2, 230);
        } else {
            game.font.setColor(1,1,1,1);
            game.font.draw(game.batch, "NO", RhythmGame.V_WIDTH / 2 - TextUtil.getTextWidth(game.font,"NO") / 2, 230);
        }
        if (selection == 1) {
            game.font.setColor(0,1,1,1);
            game.font.draw(game.batch, "YES", RhythmGame.V_WIDTH / 2 - TextUtil.getTextWidth(game.font,"YES") / 2, 170);
        } else {
            game.font.setColor(1,1,1,1);
            game.font.draw(game.batch, "YES", RhythmGame.V_WIDTH / 2 - TextUtil.getTextWidth(game.font,"YES") / 2, 170);
        }
